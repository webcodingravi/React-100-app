    ...
    return (
        <>
            <div className='bg-white min-h-screen'>
                <div className='w-full mx-auto bg-[url("/image/background.jpg")] min-h-screen pt-12 pb-48'>
                    ...
                    <div className='px-4 md:px-8 pb-5 fixed bottom-0 w-full bg-[url("/image/background.jpg")]'>
